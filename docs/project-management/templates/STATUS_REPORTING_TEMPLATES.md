...
## Template 1: Daily Status Update (Internal Team)

### Posted in: Slack #standup channel
...
## Template 2: Weekly Status Report (Executive Summary)

### Sent to: Project Sponsor

**Subject**: Eucharist Platform - Weekly Status Report [Week of Date]
...
[High-level summary of the week's progress and status]
...
- **Team Capacity**: [X]% ([Y] of [Z] team members available)
- **Morale**: 🟢 Good | 🟡 Concerns | 🔴 Issues
- **Notable**: [Any team changes, achievements, concerns]
...
**Subject**: Sprint [X] Report - [Sprint Goal]
...
**Outcome**: ✅ Goal Met | ⚠️ Partially Met | ❌ Not Met

---

## Sprint Summary

[2-3 sentence narrative of sprint outcomes]
...
## Template 4: Monthly Stakeholder Report

### Sent to: All Stakeholders

**Subject**: Eucharist Platform Monthly Report - [Month Year]
...
- **Phase End**: [Date]
- **Days Remaining**: [X]
- **Status**: 🟢 On Schedule | 🟡 Minor Delay | 🔴 Behind Schedule
...
**Business Impact**: [Schedule/Budget/Quality impact]  
**Affected Users**: [Number or percentage if known]

**Timeline Impact**: [Days delayed or affected]  
**Budget Impact**: [Cost if applicable]
...
**Confirmed Root Cause**: [Once determined]
...
- **Format**: Detailed issue documentation
